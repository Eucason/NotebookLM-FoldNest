/**
 * NotebookLM FoldNest - Note Pop-out Module
 * v0.8.9 - Pop-out notes into separate windows for reference
 * 
...
(function () {
    ...
    /**
     * Initialize the module once NotebookLM FoldNest namespace is available
     */
    function initModule() {
        if (typeof window.NotebookLMFoldNest === 'undefined') {
            initAttempts++;
        ...
        window.NotebookLMFoldNest.openNotePopout = openNotePopout;
